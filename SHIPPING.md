...
Total skills: 45 (**45 ✅ Stable**, 0 🟡 In development). Depth: **19 Core · 23 Lite ·
3 routing** (see [Depth tiers](#depth-tiers-core--lite--routing--a-partition-of-the-45)).

## ✅ Shipping (v1.6.0) — 45 skills
...
- **Core (19)** — deepened this release into a real 3-layer skill: earned per-skill
...
- **Lite (23)** — Stable, with a real free/built-in path, but single-file; slated for
...
```depth-tiers
core:    design-system-gen, design-build, design-research, design-accessibility, design-visual-qa, qa-gate, parallel-build, portable-html-port, seo-audit, seo-cluster, seo-drift, seo-geo, seo-local-unified, seo-strategy, seo-technical, seo-schema, seo-page, seo-content, seo-sitemap
lite:    design-dimensions, design-motion, design-system-persist, design-tokens-emit, design-cro, blast-prompt, html-extract, copywriting, content-draft, csv-to-report, client-outreach, seo-image-audit, seo-content-brief, seo-sxo, seo-hreflang, seo-competitor-pages, seo-programmatic, seo-ecommerce, seo-google, seo-dataforseo, seo-firecrawl, seo-backlinks, seo-image-gen
routing: route-three-brain, route-codex-review, route-gemini-context
```

**45 Stable = 19 Core + 23 Lite + 3 routing.**
...
- **seo/** — `ai_crawlers` (the one AI-crawler registry + RFC 9309 robots evaluator),
  ...
  `hreflang_tools`, `link_graph` (internal-link architecture), `llms_txt` (llms.txt generate/validate), `nap_check`, `page_fetch`, `schema_gen`, `serp_cluster`,
