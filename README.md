...
> **Shipping status (v1.4.0 "Depth Sweep" in progress).** **45 of 45 skills are Stable** — **16 Core,
...
## Shipping skills (v1.4.0) — 45 Stable, mostly free-tier
...
Backed by **34 scripts** — all standard-library-only Python; every one but the design
